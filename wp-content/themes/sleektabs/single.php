...
if (have_posts()) : ?>
		<?php while (have_posts()) : the_post(); ?>
				...
				<?php }?>
                <div class="meta"><span class="floatleft"><span class='meta_date'><?php the_time('d.m.Y') ?></span>  <span class="meta_cat"><?php the_category(', '); ?></span><span class="meta_comment"><?php comments_number('No Comments', '1 Comment', '% Comments'); ?></span></span></div>
...
<?php 
	...
	echo'<div><input id="ajax_geturl" name="ajax_geturl" type="hidden" value="';
	the_permalink();
	echo '" /></div>';
